...
describe BriefsController do
  ...
  describe "GET show" do
    it "assigns the requested brief as @brief" do
      brief = Brief.create! valid_attributes
      get :show, {:id => brief.to_param}, valid_session
  ...
  describe "GET edit" do
    it "assigns the requested brief as @brief" do
      brief = Brief.create! valid_attributes
      get :edit, {:id => brief.to_param}, valid_session
      assigns(:brief).should eq(brief)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new Brief" do
        expect {
          post :create, {:brief => valid_attributes}, valid_session
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved brief as @brief" do
        ...
        post :create, {:brief => { "title" => "invalid value" }}, valid_session
        assigns(:brief).should be_a_new(Brief)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested brief" do
        ...
        Brief.any_instance.should_receive(:update_attributes).with({ "title" => "MyString" })
        put :update, {:id => brief.to_param, :brief => { "title" => "MyString" }}, valid_session
      end

      it "assigns the requested brief as @brief" do
        brief = Brief.create! valid_attributes
        put :update, {:id => brief.to_param, :brief => valid_attributes}, valid_session
        assigns(:brief).should eq(brief)
      end
    ...
    describe "with invalid params" do
      it "assigns the brief as @brief" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Brief.any_instance.stub(:save).and_return(false)
        put :update, {:id => brief.to_param, :brief => { "title" => "invalid value" }}, valid_session
        assigns(:brief).should eq(brief)
      end
  ...
  describe "DELETE destroy" do
    it "destroys the requested brief" do
      brief = Brief.create! valid_attributes
      expect {
        delete :destroy, {:id => brief.to_param}, valid_session
      }.to change(Brief, :count).by(-1)
    end
